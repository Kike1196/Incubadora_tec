...
import { demoPeople, dateLabel } from './data';
import { Badge, Heading, Panel, Progress, Stats } from './ui';
...
export default function Home() {
  ...
  return <><Heading eyebrow={role === 'admin' ? 'COORDINACIÓN / INICIO' : 'TU ESPACIO DE EMPRENDIMIENTO'} title={role === 'admin' ? 'Panel de coordinación' : `Hola, ${demoPeople[role].split(' ')[0]}`} description={role === 'admin' ? 'Una vista de tu comunidad y las herramientas para acompañarla.' : 'Cada paso acerca tu idea a convertirse en una empresa.'} />
